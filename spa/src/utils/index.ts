import type { SblFileNodeAssert, SblFolderNodeAssert, SblNode } from "@simple-b2-list/types";
...
export function calcCurrentFolderNode(rootNode: SblFolderNodeAssert, path: string) {
